...
class DefaultCard extends Component {
  ...
  style() {
    return ({
        cardContainer: {
          width: '250px', height: '100%', padding: '5px', minWidth: '230px',
          float: 'left !important',// transform: this.props.cardStyle.transform,
          position: 'relative', display: 'inline-block', left: '0',
          clear: 'both', verticalAlign: 'top', transition: 'transform .3s ease'
        },
        cardBody: {
